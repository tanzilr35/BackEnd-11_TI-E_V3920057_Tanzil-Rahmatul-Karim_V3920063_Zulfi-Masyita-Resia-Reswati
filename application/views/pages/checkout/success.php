        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ol>
                        <li>Lakukan pembayaran pada rekening <strong>BCA 123901249421</strong> a/n RR Entertaiment</li>
                    ...
                    <a href="<?= base_url('home') ?>" class="btn btn-info"><i class="fas fa-angle-left"></i> Kembali</a>
                </div>
            </div>
        </div>
    </div>
